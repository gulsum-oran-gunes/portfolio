...
import { TbBrandGmail, TbBrandMailgun } from "react-icons/tb";
...
export default function Hero() {
  const words = [
    ...
    "JavaScript Fan — Angular & React Friendly",
    "AWS: My Cloud Playground",
  ];
...
const profile = {
    ...
    skills: [
        '.NET', 'React', 'JavaScript', 'Angular',
        'MSSQL', 'MongoDB', 'PostgreSQL', 'AWS', 'TypeScript',
        'Figma', 'Git', 'Python', 'API Development'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                .NET Focused ✨ | Angular & React Enthusiast ✨ | Crafting Modern Web Applications
                </p>
              </div>
                ...
                <div className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-teal-400 p-0.5 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#60A5FA]">
                  <div className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-teal-400">
                    <div className="relative flex items-center justify-center gap-6 text-white font-medium ">
                      <a href="https://github.com/gulsum-oran-gunes" target="_blank" >
                        <Github />
                      </a>

                      <a href="https://www.linkedin.com/in/gulsum-oran-gunes/" target="_blank" >
                        <LucideLinkedin />
                      </a>

                      <a href="mailto:avgulsumoran@gmail.com">
                        <MailIcon />
                      </a>
              ...
              <div className="hidden lg:block absolute top-[17rem] left-[70%] transform -translate-x-1/2 animate-float">
                <div className="px-4 py-2 rounded-lg bg-amber-500/10 backdrop-blur-sm border border-amber-500/20 text-amber-400">
                  <i className="fas fa-lightbulb"></i>&nbsp;&nbsp;Adaptive
                </div>
              </div>
            </div>
